...
const s = StyleSheet.create({
  ...
  // ── Header ──────────────────────────────────────────────────────────────────
  header: { paddingHorizontal: 16, paddingBottom: 12, overflow: 'hidden', position: 'relative' },
  headerAccentLine: { position: 'absolute', top: 0, left: 0, right: 0, height: 2.5, backgroundColor: P.terra },
  headerTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  headerEyebrow: { fontSize: 9, fontWeight: '700', color: P.amber, letterSpacing: 1.6, textTransform: 'uppercase', marginBottom: 2 },
  headerTitle: { fontSize: 21, fontWeight: '900', color: P.white, letterSpacing: -0.4 },
  headerGlowLine: { height: 1.25, marginTop: 10 },

  publishBtn: { borderRadius: 11, overflow: 'hidden', shadowColor: P.terra, shadowOpacity: 0.32, shadowOffset: { width: 0, height: 3 }, shadowRadius: 8, elevation: 5 },
  publishBtnGrad: { paddingHorizontal: 13, paddingVertical: 8 },
  publishBtnTxt: { fontSize: 11.5, fontWeight: '800', color: P.white },

  // Stats
  statsRow: { flexDirection: 'row', gap: 6 },
  statCard: { flex: 1, borderRadius: 12, overflow: 'hidden' },
  statCardGrad: { paddingVertical: 7, paddingHorizontal: 8, alignItems: 'center', position: 'relative', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', borderRadius: 12, gap: 1 },
  statCardAccent: { position: 'absolute', top: 0, left: 0, right: 0, height: 2, backgroundColor: P.terra },
  statIcon: { fontSize: 14, marginBottom: 0 },
  statValue: { fontSize: 13.5, fontWeight: '900', color: P.white, lineHeight: 16 },
  statLabel: { fontSize: 8.5, color: 'rgba(255,255,255,0.5)', fontWeight: '600', lineHeight: 11 },

  // ── Recherche ────────────────────────────────────────────────────────────────
  searchSection: { flexDirection: 'row', paddingHorizontal: 12, paddingVertical: 10, gap: 8 },
  searchBar: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: P.white, borderRadius: 11, paddingHorizontal: 10, borderWidth: 1, borderColor: P.dim, gap: 7 },
  searchIcon: { fontSize: 15 },
  searchInput: { flex: 1, fontSize: 13, color: P.charcoal, paddingVertical: 9 },
  searchClear: { padding: 4 },
  searchClearTxt: { fontSize: 12, color: P.muted, fontWeight: '700' },
  filterBtn: { backgroundColor: P.white, paddingHorizontal: 11, borderRadius: 11, justifyContent: 'center', borderWidth: 1, borderColor: P.dim },
  filterBtnActive: { backgroundColor: P.peachSoft, borderColor: 'rgba(236,90,19,0.35)' },
  filterBtnTxt: { fontSize: 12, fontWeight: '600', color: P.muted },
